  ...
  return (
    ...
    flex items-center justify-center">
      ...
      shadow-xl w-full max-w-lg p-8">
          ...
          text-gray-800 mb-2 text-center">Task Manger</h1>
      
        <form onSubmit={addTodo} 
         className="flex items-center gap-2 
        shdow-sm border border-gray-200 p-2 rounded-lg ">
          <input
          className="outline-none px-3 py-2
           flex-1 ext-gray-700 placeholder-gray-400"
           type="text"
          value={newTodo}
          ...
          py-2 rounded-md font-medium cursor-pointer">Add Task</button>
        </form>
        <div className="mt-4">
          {todos.length === 0 ? (
            <div>No to do yet</div>
          ):(
                ...
                <div key={todo._id}>
                 {editingTodo === todo._id ? (
                  <div className="flex items-center gap-x-3">
                    <input
                     className="flex-1 p-3 border rounded-large
                    ...
                    <button
                     className="px-4 py-2 
                     bg-red-300 text-gray-700 rounded-lg
